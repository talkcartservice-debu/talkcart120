...
const AchievementFeed: React.FC<AchievementFeedProps> = ({ limit = 10 }) => {
  ...
  useEffect(() => {
    const fetchAchievements = async () => {
      try {
        ...
        // Fetch achievement posts from the API
        const response: any = await api.posts.getAchievements({ limit });
