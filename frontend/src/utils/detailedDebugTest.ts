...
const url = mediaItemWithDuplicatePath.secure_url || (mediaItemWithDuplicatePath as any).url;
...
edgeCases.forEach((testCase, index) => {
  ...
  const url = testCase.mediaItem.secure_url || (testCase.mediaItem as any).url;
  console.log('URL:', url);
