...
console.log('✓ AppLayout now shows sidebar on desktop (isDesktop condition added)');
console.log('✓ Sidebar uses persistent variant on desktop for continuous display');
...
console.log('✓ Sidebar still works on mobile and tablet as before');
...
console.log('\nSummary of changes:');
console.log('- Updated AppLayout to show sidebar on desktop (isDesktop condition)');
console.log('- Maintained persistent variant for desktop sidebar');
